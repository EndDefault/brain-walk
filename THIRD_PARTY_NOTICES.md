...
확인일: 2026-09-23. 외부 이미지·음원·폰트 파일·학습 데이터가 없습니다. 앱 아이콘은 프로젝트에서 직접 작성한 VectorDrawable이며, 화면 글꼴은 Android의 시스템 기본 글꼴을 사용합니다. 게임 엔진의 그림은 식별자만 정의했으며 렌더러는 아직 추가하지 않았습니다.
